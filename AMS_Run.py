    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Vedant Oza/Downloads/FRAMS/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:\Users\Vedant Oza\Downloads\FRAMS\Attendance\Manually Attendance\"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Vedant Oza\Downloads\FRAMS\Attendance\-------Check atttendance-------"')
